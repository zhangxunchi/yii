        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo Url::to(['manage/changepassword'])?>">修改密码</a></li>
                </ul>
            </li>
            <li class="settings hidden-phone">
                <a href="<?php echo \yii\helpers\Url::to(['public/login'])?>" role="button"> <!--退出-->
...
<div id="sidebar-nav">
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="<?php echo Url::to(["site/index"])?>">收货地址管理</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="<?php echo Url::to(["notice/index"])?>">公告列表</a></li>
            </ul>
        </li>
        ...
        <li>
          <!--  <a class="dropdown-toggle" href="#">
           ...
           <!-- <ul class="submenu">
                <li><a href="<?php /*echo Url::to(["head/index"])*/?>">头部广告图片列表</a></li>
            </ul>-->
        </li>
