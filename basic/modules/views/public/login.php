...
<?php $form = ActiveForm::begin(['fieldConfig'=>['template'=>'{error}{input}']]);?>
    <div class="span4 box">
        <div class="content-wrap">
            ...
            <a href="<?php echo Url::to(['public/seeckpassword'])?>" class="forgot">忘记密码</a>
            <?php echo $form->field($model,'rememberMer')->checkbox(['id'=>'remember','template'=>' <div class="remember">{input}<label for="remember-me">记住我</label></div>']);?>
