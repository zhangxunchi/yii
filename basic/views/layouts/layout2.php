...
<div class=" block header_bg" style="margin-bottom: 0px;">
    ...
    <div class="header_top logo_wrap"> <a class="logo_new" href="index.php"><img src="assets/images//logo.gif" /></a>
        ...
        <ul class="cart_info" style="position: relative;left:80px;">
            <li id="ECS_CARTINFO"><span class="carts_num none_f"><a href="<?php echo Url::to(['flow/index'])?>" title="查看购物车">2</a></span> <em class="i_cart">&nbsp;</em><a href="<?php echo Url::to(['flow/index'])?>">查看购物车</a></li>
            <li><a href="user.php">我的订单</a></li>
            <li><a href="<?php echo Url::to(["flow/site"])?>" target="_blank"><em class="i_order">&nbsp;</em>添加收货地址</a></li>
            <li><a href="<?php echo Url::to(["flow/shipping"])?>" target="_blank"><em class="i_order">&nbsp;</em>我的收货地址</a></li>
        </ul>
    </div>
</div>
