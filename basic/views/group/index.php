<div class="block box">
    <div class="blank"></div>
    <div id="ur_here">
        当前位置: <a href="mbmeilishuo/">首页</a> <code>&gt;</code> <a href="mbmeilishuo/group_buy.php">团购商品</a>
    </div>
</div>
<div class="blank"></div><div class="block clearfix">
    ...
    <div class="AreaR">
            ...
            <div class="box_1">
                ...
                <div class="boxCenterList">
                    <ul class="group clearfix">
                        <li class="f_l">
                            <a href="mbmeilishuo/group_buy.php?act=view&amp;id=18"><img src="images/134_thumb_G_1413930635678.jpg" alt="韩味HW-2014初冬套装 毛衣外套 长袖连衣裙 蓬蓬裙 气质长袖针织衫+半身裙 两件套连衣裙套装" style="vertical-align: middle" border="0"></a>
                        </li>
                        <li class="f_r" style="float:right; margin-right:130px;">
                            团购商品：<a href="mbmeilishuo/group_buy.php?act=view&amp;id=18" class="f5">韩味HW-2014初冬套装 毛衣外套 长袖连衣裙 蓬蓬裙 气质长袖针织衫+半身裙 两件套连衣裙套装</a><br>
                            ...
                            <table bgcolor="#dddddd" border="0" cellpadding="5" cellspacing="1" width="100%">
                                <tbody><tr>
                                    ...
                                    <th bgcolor="#FFFFFF" width="71%">价格</th>
                                </tr>
                                <tr>
                                    <td bgcolor="#FFFFFF" width="29%">10</td>
                                    <td bgcolor="#FFFFFF" width="71%">28元</td>
                                </tr>
                                </tbody></table>
                        </li>
                    </ul>
        ...
        <form name="selectPageForm" action="/mbmeilishuo/group_buy.php" method="get">
